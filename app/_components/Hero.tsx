    ...
    <>
      ...
      >
        ...
        >
          <div style={{ minWidth: 0 }}>
            ...
            >
              ...
              Surfboard ding repairs · Noordhoek, Cape Town
            </div>
            <h1
              style={{
                fontWeight: 900,
          ...
          <div style={{ minWidth: 0 }}>
            <div
              style={{
                position: "relative",
                background: "linear-gradient(180deg,#0C74BE 0%,#0A5D9A 100%)",
                borderRadius: 26,
                padding: "30px 26px 22px",
                boxShadow: "0 30px 60px rgba(11,34,51,0.22)",
                overflow: "hidden",
              }}
            >
              <div
                style={{
                  position: "absolute",
                  inset: 0,
                  background: "radial-gradient(80% 60% at 50% 18%,rgba(255,255,255,0.16),transparent 60%)",
                }}
              />
              <div
                style={{
              ...
              >
                <span style={{ fontWeight: 800, fontStyle: "italic", fontSize: 18, color: "#fff" }}>
                  SURF<span style={{ color: "#FFE400" }}>IX</span>
                </span>
                <span
                  style={{
                    fontSize: 11,
        ...
        <svg
          ...
          style={{ display: "block", width: "100%", height: 80, marginTop: 30 }}
        >
          <path
